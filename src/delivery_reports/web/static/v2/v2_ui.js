...
(function () {
  ...
  var DEMO_STEPS = [
    {
      ico: '✏️',
      title: 'Апдейт текстом',
      desc: 'Пишите апдейты текстом в Telegram или Mini App — в любое время дня. Voice — в PRO.'
    },
    {
      ico: '🧠',
      title: 'Разложит по проектам',
      desc: 'PM Digest автоматически определяет: что сделано, что планируется, какие риски и блокеры — без ручной работы.'
    },
    {
      ico: '📋',
      title: 'Черновик готов',
      desc: 'Открывайте отчёт в Mini App, проверяйте и дополняйте детали перед финальной отправкой.'
    },
    {
      ico: '📤',
